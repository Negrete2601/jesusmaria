...
foreach ($requisitos_tramite as $requisito) 
{
  ...
  $archivo='../../carga_tramites/'.$requisito['documento'];
  if(is_file($archivo))
  {
    $documento = '<td><a href="carga_tramites/'.$requisito['documento'].'" class="btn btn-xs" target="_blank"><i class="fas fa-download"></i></a></td>';
  }else{
     $documento = '<td></td>';
  }
  $i++;
