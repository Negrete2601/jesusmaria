            ...
            <div class="container py-5">
                <div class="section-title text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 70px;">
                    <div>
                            ...
                            <p><br>
                            <span style="font-size: xx-large;">Ser un municipio de vanguardia en el desarrollo sustentable en Aguascalientes, reconocido a nivel regional y nacional por sus buenas prácticas gubernamentales y cumplimiento de la normatividad aplicable en administración pública. </span></p>
                    </div>
                </div>
